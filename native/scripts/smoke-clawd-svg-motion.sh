...
SMOKE_ROOT="${1:-${TMPDIR:-/tmp}/clawd-native-clawd-svg-motion-$RUN_ID}"
APP_PID=""
CURRENT_LOG=""
CURRENT_PORT=""
...
post_working() {
  curl -fsS \
    ...
    --data '{"state":"working","session_id":"native-clawd-svg-motion","event":"StateMatrix","agent_id":"codex","session_title":"clawd svg motion","display_svg":"clawd-working-typing.svg","cwd":"/tmp/clawd-native-clawd-svg-motion"}' \
...
sleep 2.6
capture_window "$SMOKE_ROOT/clawd-working-typing-a.png"
sleep 1.2
